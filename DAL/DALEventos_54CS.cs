...
namespace DAL
{
    public class DALEventos_54CS
    {
        ...
        {
            string query = $"INSERT INTO Eventos_54CS(Login_54CS,Fecha_54CS,Hora_54CS,Modulo_54CS,Evento_54CS,Criticidad_54CS) VALUES ('{eventito.Login_54CS}','{eventito.Fecha_54CS}','{eventito.Hora_54CS}','{eventito.Modulo_54CS}','{eventito.Evento_54CS}','{eventito.Criticidad_54CS}')";
